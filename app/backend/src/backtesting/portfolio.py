...
class Portfolio:
    ...
    def get_snapshot(self) -> PortfolioSnapshot:
        """Get a snapshot of the portfolio state."""
        ...
        gains_copy: dict[str, TickerRealizedGains] = {
            t: {"long": g["long"], "short": g["short"]} for t, g in self._portfolio["realized_gains"].items()
        }
        return {
    ...
    def get_realized_gains(self) -> Mapping[str, TickerRealizedGains]:
        """Get the current realized gains."""
