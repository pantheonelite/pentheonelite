...
export function RightSidebar({
  ...
  return (
    <div
      ref={elementRef}
      className={cn(
        "h-full flex flex-col relative pt-4 border-2 border-pantheon-border bg-pantheon-cosmic-surface shadow-[0_0_10px_hsl(var(--pantheon-primary-500)/0.2)]",
        isCollapsed ? "shadow-[0_0_20px_hsl(var(--pantheon-primary-500)/0.3)]" : ""
      )}
      style={{
        width: `${width}px`
      }}
