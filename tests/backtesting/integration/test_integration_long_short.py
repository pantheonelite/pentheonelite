    ...
    decision_sequence = [
        {
            ...
            "MSFT": {"action": "short", "quantity": 20},
        },
        {},
        {
            "AAPL": {"action": "sell", "quantity": 20},
            "MSFT": {"action": "cover", "quantity": 10},
        },
        {},
    ]
...
def test_long_short_strategy_directional_flip_on_ticker():
    ...
    decision_sequence = [
        ...
        {
            "AAPL": {"action": "buy", "quantity": 40},
            "TSLA": {"action": "short", "quantity": 20},
        },
        # Day 2: Exit AAPL long fully; exit TSLA short fully
        {
            "AAPL": {"action": "sell", "quantity": 40},
            "TSLA": {"action": "cover", "quantity": 20},
        },
        # Day 3: Flip directions: Short AAPL 25, Long TSLA 15
        {
            "AAPL": {"action": "short", "quantity": 25},
            "TSLA": {"action": "buy", "quantity": 15},
        },
        # Day 4: Hold
        {},
    ]
...
def test_long_short_strategy_dca_both_sides():
    ...
    decision_sequence = [
        # Day 1: seed positions
        {
            ...
            "MSFT": {"action": "short", "quantity": 15},
        },
        # Day 2: add to both sides (new prices -> test weighted cost bases)
        {
            "AAPL": {"action": "buy", "quantity": 20},
            "MSFT": {"action": "short", "quantity": 10},
        },
        # Day 3: hold
        {},
        # Day 4: partial exits: sell some AAPL, cover some MSFT
        {
            "AAPL": {"action": "sell", "quantity": 25},
            "MSFT": {"action": "cover", "quantity": 12},
        },
    ]
